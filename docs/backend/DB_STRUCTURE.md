...
**Stack:** PostgreSQL 16+, Eloquent ORM (Laravel 12). Усі timestamp'и — `TIMESTAMPTZ` в UTC. PK — UUIDv7 (`gen_random_uuid()` або Laravel's `Str::orderedUuid()`).
